...
Public Class Litigio
    Private Sub Litigio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet.Litigio' Puede moverla o quitarla según sea necesario.
        ' Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet.Mediacion' Puede moverla o quitarla según sea necesario.
        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet2.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet1.Litigio' Puede moverla o quitarla según sea necesario.
        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet6.Litigio' Puede moverla o quitarla según sea necesario.
        ' Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet1.Litigio' Puede moverla o quitarla según sea necesario.
        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet1.Litigio' Puede moverla o quitarla según sea necesario.
        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet5.Litigio' Puede moverla o quitarla según sea necesario.
        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet.Litigio)
        'TODO: esta línea de código carga datos en la tabla 'MediacionDataSet.Litigio' Puede moverla o quitarla según sea necesario.

        'Me.LitigioTableAdapter.Fill(Me.MediacionDataSet6.Litigio)
    ...
    Sub Agregar_Solicitante_Litigio()
        ...
        Try
            If agregardatos_litigio = vbYes Then
                ...
                Dim Insdatosa As String = "INSERT INTO Litigio (Fecha_Asesoria_L,Nombre_Solicitante_L,Domicilio_L,Colonia_L,Mpio_L,Edo_L,Tel_Oficina_L,Tel_Celular_L,E_mail_L,Edo_Civil_L,Ocupacion_L,Asunto_L,Mediador_L,Usuario) values(@Fecha_Asesoria_L,@Nombre_Solicitante_L,@Domicilio_L,@Colonia_L,@Mpio_L,@Edo_L,@Tel_Oficina_L,@Tel_Celular_L,@E_mail_L,@Edo_Civil_L,@Ocupacion_L,@Asunto_L,@Mediador_L,@Usuario)"
                ...
                conex1.Parameters.Add(New SqlParameter("@E_mail_L", SqlDbType.NVarChar, 50)).Value = Me.TBE_mail.Text
    ...
    Sub Actualizar_Datos_Litigio()
        Try
            ...
            If Actualizar_Li = vbYes Then
                ...
                conex2.Parameters.Add(New SqlParameter("@E_mail_L", SqlDbType.NVarChar, 50)).Value = Me.TBE_mail.Text
                ...
                conex2.Parameters.Add(New SqlParameter("@Usuario", SqlDbType.NVarChar, 20)).Value = LoginMediacion.UsernameTextBox.Text
