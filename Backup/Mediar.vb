    ...
    Sub Agregar_Solicitante_Mediacion()
        ...
        Try
            If agregardatos_solicitud = vbYes Then
                ...
                Dim Insdatomedia As String = "INSERT INTO Mediacion (Fecha_Asesoria_M,Nombre_Solicitante_M,Domicilio_M,Colonia_M,Mpio_M,Edo_M,Tel_Oficina_M,Tel_Celular_M,E_mail_M,Edo_Civil_M,Ocupacion_M,Asunto_M,Nombre_Invitado,Domicilio_I,Colonia_I,Mpio_I,Edo_I,Tel_Oficina_I,Tel_Celular_I,E_mail_I,Edo_Civil_I,Ocupacion_I,Mediador_M) values(@Fecha_Asesoria_M,@Nombre_Solicitante_M,@Domicilio_M,@Colonia_M,@Mpio_M,@Edo_M,@Tel_Oficina_M,@Tel_Celular_M,@E_mail_M,@Edo_Civil_M,@Ocupacion_M,@Asunto_M,@Nombre_Invitado,@Domicilio_I,@Colonia_I,@Mpio_I,@Edo_I,@Tel_Oficina_I,@Tel_Celular_I,@E_mail_I,@Edo_Civil_I,@Ocupacion_I,@Mediador_M)"
    ...
    Sub Actualizar_Datos_Mediacion()
        Try
            ...
            If Actualizar_Mi = vbYes Then
                Dim Actualizar_Datos_Mediacion As String = ("UPDATE Mediacion SET Fecha_Asesoria_M=@Fecha_Asesoria_M,Nombre_Solicitante_M=@Nombre_Solicitante_M,Domicilio_M=@Domicilio_M,Colonia_M=@Colonia_M,Mpio_M=@Mpio_M,Edo_M=@Edo_M,Tel_Oficina_M=@Tel_Oficina_M,Tel_Celular_M=@Tel_Celular_M,E_mail_M=@E_mail_M,Edo_Civil_M=@Edo_Civil_M,Ocupacion_M=@Ocupacion_M,Asunto_M=@Asunto_M,Mediador_M=@Mediador_M where Folio_Mediacion= '" & TBFolioMediacion.Text & "'")
                ...
                Dim Actualizar_Datos_Invitado As String = ("UPDATE Mediacion SET Nombre_Invitado=@Nombre_Invitado,Domicilio_I=@Domicilio_I,Colonia_I=@Colonia_I,Mpio_I=@Mpio_I,Edo_I=@Edo_I,Tel_Oficina_I=@Tel_Oficina_I,Tel_Celular_I=@Tel_Celular_I,E_mail_I=@E_mail_I,Edo_Civil_I=@Edo_Civil_I,Ocupacion_I=@Ocupacion_I where Folio_Mediacion= '" & TBFolioMediacion.Text & "'")
